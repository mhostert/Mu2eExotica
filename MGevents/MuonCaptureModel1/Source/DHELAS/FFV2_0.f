...
C     -(P(-1,3)*Gamma(-1,2,-2)*Gamma(3,-2,1)) +
...
C     
     ...
     $ -1D0)*(+CI*(V3(4))+V3(5))+P3(3)*(V3(3)-V3(6))))))+(F1(5)*(F2(5)
     $ *(P3(0)*(V3(3)-V3(6))+(P3(1)*(-1D0)*(V3(4)+CI*(V3(5)))+(P3(2)*(
     $ +CI*(V3(4))-V3(5))+P3(3)*(V3(3)-V3(6)))))+F2(6)*(P3(0)*(-1D0)
     $ *(V3(4)+CI*(V3(5)))+(P3(1)*(V3(3)-V3(6))+(P3(2)*(+CI*(V3(3))-CI
     $ *(V3(6)))+P3(3)*(V3(4)+CI*(V3(5)))))))+F1(6)*(F2(5)*(P3(0)*(
     $ -V3(4)+CI*(V3(5)))+(P3(1)*(V3(3)+V3(6))+(P3(2)*(-1D0)*(+CI
     $ *(V3(3)+V3(6)))+P3(3)*(-V3(4)+CI*(V3(5))))))+F2(6)*(P3(0)*(V3(3)
     $ +V3(6))+(P3(1)*(-V3(4)+CI*(V3(5)))+(P3(2)*(-1D0)*(+CI*(V3(4))
     $ +V3(5))-P3(3)*(V3(3)+V3(6)))))))))
