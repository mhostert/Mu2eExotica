...
C     
C     Process: mu- pp > vm chi1 e+ e- QEDp<=5 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MMU,+1,+1*IC(1),W(1,1))  !  count 4
      CALL IXXXXX(P(0,1),MDL_MMU,-1,+1*IC(1),W(1,2))  !  count 4
      CALL IXXXXX(P(0,2),MDL_MP,+1,+1*IC(2),W(1,3))  !  count 4
      CALL IXXXXX(P(0,2),MDL_MP,-1,+1*IC(2),W(1,4))  !  count 4
      CALL OXXXXX(P(0,3),ZERO,+1,+1*IC(3),W(1,5))  !  count 4
      CALL OXXXXX(P(0,3),ZERO,-1,+1*IC(3),W(1,6))  !  count 4
      CALL OXXXXX(P(0,4),MDL_MCHI1,+1,+1*IC(4),W(1,7))  !  count 32
      CALL OXXXXX(P(0,4),MDL_MCHI1,-1,+1*IC(4),W(1,8))  !  count 32
      CALL IXXXXX(P(0,5),MDL_ME,+1,-1*IC(5),W(1,9))  !  count 2
      CALL IXXXXX(P(0,5),MDL_ME,-1,-1*IC(5),W(1,10))  !  count 2
      CALL OXXXXX(P(0,6),MDL_ME,+1,+1*IC(6),W(1,11))  !  count 2
      CALL OXXXXX(P(0,6),MDL_ME,-1,+1*IC(6),W(1,12))  !  count 2
      CALL FFFF1_2_3_4_5_2(W(1,3),W(1,1),W(1,5),GC_6,GC_9,GC_5,GC_8,GC_7
     $,MDL_MCHI2,FK_MDL_WCHI2,W(1,13))  !  count 8
      CALL FFFF1_2_3_4_5_2(W(1,3),W(1,1),W(1,6),GC_6,GC_9,GC_5,GC_8,GC_7
     $,MDL_MCHI2,FK_MDL_WCHI2,W(1,14))  !  count 8
      CALL FFFF1_2_3_4_5_2(W(1,3),W(1,2),W(1,5),GC_6,GC_9,GC_5,GC_8,GC_7
     $,MDL_MCHI2,FK_MDL_WCHI2,W(1,15))  !  count 8
      CALL FFFF1_2_3_4_5_2(W(1,3),W(1,2),W(1,6),GC_6,GC_9,GC_5,GC_8,GC_7
     $,MDL_MCHI2,FK_MDL_WCHI2,W(1,16))  !  count 8
      CALL FFFF1_2_3_4_5_2(W(1,4),W(1,1),W(1,5),GC_6,GC_9,GC_5,GC_8,GC_7
     $,MDL_MCHI2,FK_MDL_WCHI2,W(1,17))  !  count 8
      CALL FFFF1_2_3_4_5_2(W(1,4),W(1,1),W(1,6),GC_6,GC_9,GC_5,GC_8,GC_7
     $,MDL_MCHI2,FK_MDL_WCHI2,W(1,18))  !  count 8
      CALL FFFF1_2_3_4_5_2(W(1,4),W(1,2),W(1,5),GC_6,GC_9,GC_5,GC_8,GC_7
     $,MDL_MCHI2,FK_MDL_WCHI2,W(1,19))  !  count 8
      CALL FFFF1_2_3_4_5_2(W(1,4),W(1,2),W(1,6),GC_6,GC_9,GC_5,GC_8,GC_7
     $,MDL_MCHI2,FK_MDL_WCHI2,W(1,20))  !  count 8
      CALL FFV1_3(W(1,9),W(1,11),GC_4,MDL_MAP,FK_MDL_WAP,W(1,21))  !  count 16
      CALL FFV1_3(W(1,9),W(1,12),GC_4,MDL_MAP,FK_MDL_WAP,W(1,22))  !  count 16
      CALL FFV1_3(W(1,10),W(1,11),GC_4,MDL_MAP,FK_MDL_WAP,W(1,23))  !  count 16
      CALL FFV1_3(W(1,10),W(1,12),GC_4,MDL_MAP,FK_MDL_WAP,W(1,24))  !  count 16
      CALL FFV1_2P1N_1(W(1,7), W(1,21), GC_10, GC_11, TMP(1))
      call CombineAmp(8,
     & (/14,6,46,38,30,22,62,54/), 
     & (/13,14,15,16,17,18,19,20/),
     & TMP, W, AMP(1,1))
      CALL FFV1_2P1N_1(W(1,7), W(1,22), GC_10, GC_11, TMP(1))
      call CombineAmp(8,
     & (/13,5,45,37,29,21,61,53/), 
     & (/13,14,15,16,17,18,19,20/),
     & TMP, W, AMP(1,1))
      CALL FFV1_2P1N_1(W(1,7), W(1,23), GC_10, GC_11, TMP(1))
      call CombineAmp(8,
     & (/16,8,48,40,32,24,64,56/), 
     & (/13,14,15,16,17,18,19,20/),
     & TMP, W, AMP(1,1))
      CALL FFV1_2P1N_1(W(1,7), W(1,24), GC_10, GC_11, TMP(1))
      call CombineAmp(8,
     & (/15,7,47,39,31,23,63,55/), 
     & (/13,14,15,16,17,18,19,20/),
     & TMP, W, AMP(1,1))
      CALL FFV1_2P1N_1(W(1,8), W(1,21), GC_10, GC_11, TMP(1))
      call CombineAmp(8,
     & (/10,2,42,34,26,18,58,50/), 
     & (/13,14,15,16,17,18,19,20/),
     & TMP, W, AMP(1,1))
      CALL FFV1_2P1N_1(W(1,8), W(1,22), GC_10, GC_11, TMP(1))
      call CombineAmp(8,
     & (/9,1,41,33,25,17,57,49/), 
     & (/13,14,15,16,17,18,19,20/),
     & TMP, W, AMP(1,1))
      CALL FFV1_2P1N_1(W(1,8), W(1,23), GC_10, GC_11, TMP(1))
      call CombineAmp(8,
     & (/12,4,44,36,28,20,60,52/), 
     & (/13,14,15,16,17,18,19,20/),
     & TMP, W, AMP(1,1))
      CALL FFV1_2P1N_1(W(1,8), W(1,24), GC_10, GC_11, TMP(1))
      call CombineAmp(8,
     & (/11,3,43,35,27,19,59,51/), 
     & (/13,14,15,16,17,18,19,20/),
