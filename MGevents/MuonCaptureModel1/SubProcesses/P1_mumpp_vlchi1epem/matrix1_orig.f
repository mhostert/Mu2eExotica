...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
      ...
      CALL IXXXXX(P(0,1),MDL_MMU,NHEL(1),+1*IC(1),W(1,1))
      CALL IXXXXX(P(0,2),MDL_MP,NHEL(2),+1*IC(2),W(1,2))
      CALL OXXXXX(P(0,3),ZERO,NHEL(3),+1*IC(3),W(1,3))
      CALL OXXXXX(P(0,4),MDL_MCHI1,NHEL(4),+1*IC(4),W(1,4))
      CALL IXXXXX(P(0,5),MDL_ME,NHEL(5),-1*IC(5),W(1,5))
      CALL OXXXXX(P(0,6),MDL_ME,NHEL(6),+1*IC(6),W(1,6))
      CALL FFFF1_2_3_4_5_2(W(1,2),W(1,1),W(1,3),GC_6,GC_9,GC_5,GC_8
     $ ,GC_7,MDL_MCHI2, FK_MDL_WCHI2,W(1,7))
      CALL FFV1_3(W(1,5),W(1,6),GC_4,MDL_MAP, FK_MDL_WAP,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL FFV1_2_0(W(1,7),W(1,4),W(1,3),GC_10,GC_11,AMP(1))
