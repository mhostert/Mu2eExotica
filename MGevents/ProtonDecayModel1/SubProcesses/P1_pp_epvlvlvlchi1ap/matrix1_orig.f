...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,  77),I=1,7) / 1,-1,-1,-1,-1, 1, 0/
      ...
      DATA (NHEL(I, 167),I=1,7) /-1,-1, 1, 1, 1, 1, 0/
      ...
      DATA (NHEL(I, 185),I=1,7) /-1,-1,-1, 1,-1, 1, 0/
      ...
      DATA (NHEL(I, 191),I=1,7) /-1,-1,-1, 1, 1, 1, 0/
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
      ...
      CALL IXXXXX(P(0,1),MDL_MP,NHEL(1),+1*IC(1),W(1,1))
      CALL IXXXXX(P(0,2),MDL_ME,NHEL(2),-1*IC(2),W(1,2))
      CALL IXXXXX(P(0,3),ZERO,NHEL(3),-1*IC(3),W(1,3))
      CALL OXXXXX(P(0,4),ZERO,NHEL(4),+1*IC(4),W(1,4))
      CALL OXXXXX(P(0,5),ZERO,NHEL(5),+1*IC(5),W(1,5))
      CALL OXXXXX(P(0,6),MDL_MCHI1,NHEL(6),+1*IC(6),W(1,6))
      CALL VXXXXX(P(0,7),MDL_MAP,NHEL(7),+1*IC(7),W(1,7))
      CALL FFFF6_2(W(1,3),W(1,2),W(1,4),GC_3,MDL_MMU, FK_ZERO,W(1,8))
      CALL FFV1_2_1(W(1,6),W(1,7),GC_10,GC_11,MDL_MCHI2, FK_MDL_WCHI2
     $ ,W(1,4))
C     Amplitude(s) for diagram number 1
      CALL FFFF1_2_3_4_5_0(W(1,1),W(1,4),W(1,8),W(1,5),GC_6,GC_9,GC_5
     $ ,GC_8,GC_7,AMP(1))
