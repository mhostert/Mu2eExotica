...
C     
C     Process: pp > e+ vm~ ve vm chi1 e+ e- QEDp<=5 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MP,+1,+1*IC(1),W(1,1))  !  count 64
      CALL IXXXXX(P(0,1),MDL_MP,-1,+1*IC(1),W(1,2))  !  count 64
      CALL IXXXXX(P(0,2),MDL_ME,+1,-1*IC(2),W(1,3))  !  count 3
      CALL IXXXXX(P(0,2),MDL_ME,-1,-1*IC(2),W(1,4))  !  count 3
      CALL IXXXXX(P(0,3),ZERO,-1,-1*IC(3),W(1,5))  !  count 4
      CALL OXXXXX(P(0,4),ZERO,+1,+1*IC(4),W(1,6))  !  count 4
      CALL OXXXXX(P(0,5),ZERO,+1,+1*IC(5),W(1,7))  !  count 64
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,8))  !  count 64
      CALL OXXXXX(P(0,6),MDL_MCHI1,+1,+1*IC(6),W(1,9))  !  count 8
      CALL OXXXXX(P(0,6),MDL_MCHI1,-1,+1*IC(6),W(1,10))  !  count 8
      CALL IXXXXX(P(0,7),MDL_ME,+1,-1*IC(7),W(1,11))  !  count 3
      CALL IXXXXX(P(0,7),MDL_ME,-1,-1*IC(7),W(1,12))  !  count 3
      CALL OXXXXX(P(0,8),MDL_ME,+1,+1*IC(8),W(1,13))  !  count 4
      CALL OXXXXX(P(0,8),MDL_ME,-1,+1*IC(8),W(1,14))  !  count 4
      CALL FFV1_3(W(1,3),W(1,13),GC_4,MDL_MAP,FK_MDL_WAP,W(1,15))  !  count 2
      CALL FFV1_3(W(1,3),W(1,14),GC_4,MDL_MAP,FK_MDL_WAP,W(1,16))  !  count 2
      CALL FFV1_3(W(1,4),W(1,13),GC_4,MDL_MAP,FK_MDL_WAP,W(1,17))  !  count 2
      CALL FFV1_3(W(1,4),W(1,14),GC_4,MDL_MAP,FK_MDL_WAP,W(1,18))  !  count 2
      CALL FFFF6_2(W(1,5),W(1,11),W(1,6),GC_3,MDL_MMU,FK_ZERO,W(1,19))  !  count 32
      CALL FFFF6_2(W(1,5),W(1,12),W(1,6),GC_3,MDL_MMU,FK_ZERO,W(1,20))  !  count 32
      CALL FFV1_2_1(W(1,9),W(1,15),GC_10,GC_11,MDL_MCHI2,FK_MDL_WCHI2,W(
     $1,21))  !  count 8
      CALL FFV1_2_1(W(1,9),W(1,16),GC_10,GC_11,MDL_MCHI2,FK_MDL_WCHI2,W(
     $1,22))  !  count 8
      CALL FFV1_2_1(W(1,9),W(1,17),GC_10,GC_11,MDL_MCHI2,FK_MDL_WCHI2,W(
     $1,23))  !  count 8
      CALL FFV1_2_1(W(1,9),W(1,18),GC_10,GC_11,MDL_MCHI2,FK_MDL_WCHI2,W(
     $1,24))  !  count 8
      CALL FFV1_2_1(W(1,10),W(1,15),GC_10,GC_11,MDL_MCHI2,FK_MDL_WCHI2,W
     $(1,25))  !  count 8
      CALL FFV1_2_1(W(1,10),W(1,16),GC_10,GC_11,MDL_MCHI2,FK_MDL_WCHI2,W
     $(1,26))  !  count 8
      CALL FFV1_2_1(W(1,10),W(1,17),GC_10,GC_11,MDL_MCHI2,FK_MDL_WCHI2,W
     $(1,27))  !  count 8
      CALL FFV1_2_1(W(1,10),W(1,18),GC_10,GC_11,MDL_MCHI2,FK_MDL_WCHI2,W
     $(1,28))  !  count 8
      CALL FFFF1_2_3_4_5P1N_2(W(1,1), W(1,19), W(1,7), GC_6, GC_9, GC_5,
     $ GC_8, GC_7, TMP(1))
      call CombineAmp(8,
     & (/14,13,30,29,10,9,26,25/), 
     & (/21,22,23,24,25,26,27,28/),
     & TMP, W, AMP(1,1))
      CALL FFFF1_2_3_4_5P1N_2(W(1,1), W(1,19), W(1,8), GC_6, GC_9, GC_5,
     $ GC_8, GC_7, TMP(1))
      call CombineAmp(8,
     & (/6,5,22,21,2,1,18,17/), 
     & (/21,22,23,24,25,26,27,28/),
     & TMP, W, AMP(1,1))
      CALL FFFF1_2_3_4_5P1N_2(W(1,1), W(1,20), W(1,7), GC_6, GC_9, GC_5,
     $ GC_8, GC_7, TMP(1))
      call CombineAmp(8,
     & (/16,15,32,31,12,11,28,27/), 
     & (/21,22,23,24,25,26,27,28/),
     & TMP, W, AMP(1,1))
      CALL FFFF1_2_3_4_5P1N_2(W(1,1), W(1,20), W(1,8), GC_6, GC_9, GC_5,
     $ GC_8, GC_7, TMP(1))
      call CombineAmp(8,
     & (/8,7,24,23,4,3,20,19/), 
     & (/21,22,23,24,25,26,27,28/),
     & TMP, W, AMP(1,1))
      CALL FFFF1_2_3_4_5P1N_2(W(1,2), W(1,19), W(1,7), GC_6, GC_9, GC_5,
     $ GC_8, GC_7, TMP(1))
      call CombineAmp(8,
     & (/46,45,62,61,42,41,58,57/), 
     & (/21,22,23,24,25,26,27,28/),
     & TMP, W, AMP(1,1))
      CALL FFFF1_2_3_4_5P1N_2(W(1,2), W(1,19), W(1,8), GC_6, GC_9, GC_5,
     $ GC_8, GC_7, TMP(1))
      call CombineAmp(8,
     & (/38,37,54,53,34,33,50,49/), 
     & (/21,22,23,24,25,26,27,28/),
     & TMP, W, AMP(1,1))
      CALL FFFF1_2_3_4_5P1N_2(W(1,2), W(1,20), W(1,7), GC_6, GC_9, GC_5,
     $ GC_8, GC_7, TMP(1))
      call CombineAmp(8,
     & (/48,47,64,63,44,43,60,59/), 
     & (/21,22,23,24,25,26,27,28/),
     & TMP, W, AMP(1,1))
      CALL FFFF1_2_3_4_5P1N_2(W(1,2), W(1,20), W(1,8), GC_6, GC_9, GC_5,
     $ GC_8, GC_7, TMP(1))
      call CombineAmp(8,
     & (/40,39,56,55,36,35,52,51/), 
     & (/21,22,23,24,25,26,27,28/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFFF6_2(W(1,5),W(1,3),W(1,6),GC_3,MDL_MMU,FK_ZERO,W(1,29))  !  count 32
      CALL FFFF6_2(W(1,5),W(1,4),W(1,6),GC_3,MDL_MMU,FK_ZERO,W(1,30))  !  count 32
      CALL FFV1_3(W(1,11),W(1,13),GC_4,MDL_MAP,FK_MDL_WAP,W(1,31))  !  count 2
      CALL FFV1_3(W(1,11),W(1,14),GC_4,MDL_MAP,FK_MDL_WAP,W(1,32))  !  count 2
      CALL FFV1_3(W(1,12),W(1,13),GC_4,MDL_MAP,FK_MDL_WAP,W(1,33))  !  count 2
      CALL FFV1_3(W(1,12),W(1,14),GC_4,MDL_MAP,FK_MDL_WAP,W(1,34))  !  count 2
      CALL FFV1_2_1(W(1,9),W(1,31),GC_10,GC_11,MDL_MCHI2,FK_MDL_WCHI2,W(
     $1,35))  !  count 8
      CALL FFV1_2_1(W(1,9),W(1,32),GC_10,GC_11,MDL_MCHI2,FK_MDL_WCHI2,W(
     $1,36))  !  count 8
      CALL FFV1_2_1(W(1,9),W(1,33),GC_10,GC_11,MDL_MCHI2,FK_MDL_WCHI2,W(
     $1,37))  !  count 8
      CALL FFV1_2_1(W(1,9),W(1,34),GC_10,GC_11,MDL_MCHI2,FK_MDL_WCHI2,W(
     $1,38))  !  count 8
      CALL FFV1_2_1(W(1,10),W(1,31),GC_10,GC_11,MDL_MCHI2,FK_MDL_WCHI2,W
     $(1,39))  !  count 8
      CALL FFV1_2_1(W(1,10),W(1,32),GC_10,GC_11,MDL_MCHI2,FK_MDL_WCHI2,W
     $(1,40))  !  count 8
      CALL FFV1_2_1(W(1,10),W(1,33),GC_10,GC_11,MDL_MCHI2,FK_MDL_WCHI2,W
     $(1,41))  !  count 8
      CALL FFV1_2_1(W(1,10),W(1,34),GC_10,GC_11,MDL_MCHI2,FK_MDL_WCHI2,W
     $(1,42))  !  count 8
      CALL FFFF1_2_3_4_5P1N_2(W(1,1), W(1,29), W(1,7), GC_6, GC_9, GC_5,
     $ GC_8, GC_7, TMP(1))
      call CombineAmp(8,
     & (/14,13,16,15,10,9,12,11/), 
     & (/35,36,37,38,39,40,41,42/),
     & TMP, W, AMP(1,2))
      CALL FFFF1_2_3_4_5P1N_2(W(1,1), W(1,29), W(1,8), GC_6, GC_9, GC_5,
     $ GC_8, GC_7, TMP(1))
      call CombineAmp(8,
     & (/6,5,8,7,2,1,4,3/), 
     & (/35,36,37,38,39,40,41,42/),
     & TMP, W, AMP(1,2))
      CALL FFFF1_2_3_4_5P1N_2(W(1,1), W(1,30), W(1,7), GC_6, GC_9, GC_5,
     $ GC_8, GC_7, TMP(1))
      call CombineAmp(8,
     & (/30,29,32,31,26,25,28,27/), 
     & (/35,36,37,38,39,40,41,42/),
     & TMP, W, AMP(1,2))
      CALL FFFF1_2_3_4_5P1N_2(W(1,1), W(1,30), W(1,8), GC_6, GC_9, GC_5,
     $ GC_8, GC_7, TMP(1))
      call CombineAmp(8,
     & (/22,21,24,23,18,17,20,19/), 
     & (/35,36,37,38,39,40,41,42/),
     & TMP, W, AMP(1,2))
      CALL FFFF1_2_3_4_5P1N_2(W(1,2), W(1,29), W(1,7), GC_6, GC_9, GC_5,
     $ GC_8, GC_7, TMP(1))
      call CombineAmp(8,
     & (/46,45,48,47,42,41,44,43/), 
     & (/35,36,37,38,39,40,41,42/),
     & TMP, W, AMP(1,2))
      CALL FFFF1_2_3_4_5P1N_2(W(1,2), W(1,29), W(1,8), GC_6, GC_9, GC_5,
     $ GC_8, GC_7, TMP(1))
      call CombineAmp(8,
     & (/38,37,40,39,34,33,36,35/), 
     & (/35,36,37,38,39,40,41,42/),
     & TMP, W, AMP(1,2))
      CALL FFFF1_2_3_4_5P1N_2(W(1,2), W(1,30), W(1,7), GC_6, GC_9, GC_5,
     $ GC_8, GC_7, TMP(1))
      call CombineAmp(8,
     & (/62,61,64,63,58,57,60,59/), 
     & (/35,36,37,38,39,40,41,42/),
     & TMP, W, AMP(1,2))
      CALL FFFF1_2_3_4_5P1N_2(W(1,2), W(1,30), W(1,8), GC_6, GC_9, GC_5,
     $ GC_8, GC_7, TMP(1))
      call CombineAmp(8,
...
C       JAMPs contributing to orders ALL_ORDERS=1
        JAMP(1,1) = AMP( K,1)+(-1.000000000000000D+00)*AMP( K,2)
