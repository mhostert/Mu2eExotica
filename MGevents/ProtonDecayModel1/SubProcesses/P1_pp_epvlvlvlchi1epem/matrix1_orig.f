...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
      ...
      CALL FFV1_3(W(1,2),W(1,8),GC_4,MDL_MAP, FK_MDL_WAP,W(1,9))
      CALL FFFF6_2(W(1,3),W(1,7),W(1,4),GC_3,MDL_MMU, FK_ZERO,W(1,10))
      CALL FFV1_2_1(W(1,6),W(1,9),GC_10,GC_11,MDL_MCHI2, FK_MDL_WCHI2
     $ ,W(1,11))
C     Amplitude(s) for diagram number 1
      CALL FFFF1_2_3_4_5_0(W(1,1),W(1,11),W(1,10),W(1,5),GC_6,GC_9
     $ ,GC_5,GC_8,GC_7,AMP(1))
      CALL FFFF6_2(W(1,3),W(1,2),W(1,4),GC_3,MDL_MMU, FK_ZERO,W(1,11))
      CALL FFV1_3(W(1,7),W(1,8),GC_4,MDL_MAP, FK_MDL_WAP,W(1,4))
      CALL FFV1_2_1(W(1,6),W(1,4),GC_10,GC_11,MDL_MCHI2, FK_MDL_WCHI2
     $ ,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFFF1_2_3_4_5_0(W(1,1),W(1,8),W(1,11),W(1,5),GC_6,GC_9,GC_5
     $ ,GC_8,GC_7,AMP(2))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = AMP(1)+(-1.000000000000000D+00)*AMP(2)
